...
public class salary {
	...
	public salary(int id, int employee_id, int value_money, Date time_to_pay, String who_pay,
			int value_money_reward, int working_day, String description, Date created_at, int flag) {
		this.id = id;
		this.employee_id = employee_id;
		this.value_money = value_money;
		this.time_to_pay = time_to_pay;
